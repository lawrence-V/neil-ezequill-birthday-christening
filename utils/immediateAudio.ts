...
export class ImmediateAudio {
  ...
  async createAndPlayAudio(src: string, volume: number = 0.3, loop: boolean = true): Promise<boolean> {
    try {
...
export const attemptImmediatePlayback = async (src: string, volume: number = 0.3): Promise<boolean> => {
